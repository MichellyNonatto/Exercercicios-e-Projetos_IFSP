...
#define TAM 10000 // Tamanho global do vetor utilizado em TODAS as funções
...
int main()
{
   ...
   // int numeros[TAM];
    // NAS FUNÇÕES A SEGUIR ESCOLHA COMO VOCÊ QUER ORDENAR OS VALORES DENTRO DO ARRAY NUMEROS. a FUNÇÃO DESORDENADO GERA UMA SEQUÊNCIA DE NÚMEROS ALEATÓRIOS COM O RAND, JÁ A FUNÇÃO INVERTIDO GERA UMA SEUQUÊNCIA DECRESCENTE A PARTIR DO VALOR DECLARADO NA VARIÁVEL TAM.
