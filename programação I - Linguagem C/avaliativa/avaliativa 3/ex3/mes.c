...
Mes indice[12] = {{"janeiro", "jan", 31},{"fevereiro", "fev", 29},{"mar�o","mar",31},{"abril","abr", 30},{"maio","mar",31},
...
void diasTotal(int numeroMes, int diaDoMes){
	...
	printf("\nAt� o dia de escolha do m�s de %s, teremos %d dias.",indice[numeroMes].nomeMes, somaDias);
}
